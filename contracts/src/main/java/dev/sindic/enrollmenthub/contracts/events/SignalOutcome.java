 ...
 *
 * <p>Distinct from {@link CheckOutcome}, which is what a worker reports. The two overlap without
 * being interchangeable: a worker cannot conclude {@code NOT_EXECUTED}, and this event never
 * carries {@code NO_RESULT}.
 */
