...
class AmqpConfig {
    ...
    // Request queue — owned and declared by the decision-engine (ADR-13 §Channel Ownership).
     ...
     * (ADR-13 §Delivery & Concurrency Guarantees): a nacked confirm or an unroutable return surfaces as an
    ...
    /**
     * Listener container factory with a virtual-thread executor (ADR-04, {@code amqp-fraud-}
