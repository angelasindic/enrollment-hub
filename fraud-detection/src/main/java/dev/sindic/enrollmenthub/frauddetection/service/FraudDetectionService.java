 ...
 * ({@link CheckOutcome#OK}). It exists to exercise the full request/reply wiring end-to-end so a
...
public class FraudDetectionService {
    ...
    public void check(EnrollmentData enrollmentData) {
        ...
        publisher.publish(FraudCheckResult.checked(enrollmentData.enrollmentId(), CheckOutcome.OK));
    }
}
